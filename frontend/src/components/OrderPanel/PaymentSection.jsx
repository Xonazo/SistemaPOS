...
import { X, Banknote, CreditCard, PiggyBank, Truck, Trash2 } from 'lucide-react';
    ...
    <div className="bg-white rounded-md shadow-sm p-4 mt-4 ">
      ...
      <div className="mb-3">
        ...
        <div className="flex space-x-2">
          <button
            ...
            className={`flex-1 flex items-center justify-center py-2 px-4 rounded-md ${paymentMethod === 'efectivo'
          ...
          <button
            ...
            className={`flex-1 flex items-center justify-center py-2 px-4 rounded-md ${paymentMethod === 'tarjeta'
              ? 'bg-blue-600 text-white'
              : 'bg-gray-100 text-gray-700 hover:bg-gray-200'
              }`}
          >
          ...
          <button
            ...
            className={`flex-1 flex items-center justify-center py-2 px-4 rounded-md ${paymentMethod === 'transferencia'
              ? 'bg-blue-600 text-white'
              : 'bg-gray-100 text-gray-700 hover:bg-gray-200'
              }`}
          >
      ...
      <div className="mb-4">
        ...
        <div className="flex space-x-2 mb-2">
          <button
            ...
            className={`flex-1 flex items-center justify-center py-2 px-4 rounded-md ${delivery.isDelivery
              ? 'bg-blue-600 text-white'
              : 'bg-gray-100 text-gray-700 hover:bg-gray-200'
              }`}
          >
      ...
      <div className="grid grid-cols-2 gap-3">
        <button
          ...
          className={`py-2 px-4 rounded-md font-bold ${canConfirmOrder
    ...
    Finalizar Venta e Imprimir Cocina + Cliente (Ctrl+B)
      ...
      {paymentMethod === 'efectivo' && (
        <div className="mt-3 grid grid-cols-3 gap-2">
          <QuickAmountButton amount={total} onSelect={handleQuickAmountSelect} label="Exacto" icon={Banknote} />
          <QuickAmountButton amount={10000} onSelect={handleQuickAmountSelect} icon={Banknote} />
          <QuickAmountButton amount={20000} onSelect={handleQuickAmountSelect} icon={Banknote} />
        </div>
      )}
